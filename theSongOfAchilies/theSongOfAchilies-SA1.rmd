...
## Using Sentiment Analysis on the book 'The Song of Achilies'.
...
```{r import-data}
# import the book
df <- read_csv("~/theSongOfAchilies.txt")
```
...
ggplot(soa, aes(index, sentiment, fill = sentiment)) +
  ...
  labs(
    ...
    subtitle = "Book: The Song of Achilies"
  )
# No wonder I cried..
```
